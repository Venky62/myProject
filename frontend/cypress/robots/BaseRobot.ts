...
export abstract class BaseEyes {
  ...
  seesTextInElement(element: Cypress.Chainable<JQuery<HTMLElement>>, text: string) {
  ...
  hasLengthForDomElement(element: Cypress.Chainable<JQuery<HTMLElement>>, length: number) {
